...
class HashTableMapTest {
    ...
    public static <K,V> Map<K, V> newTestMapInstance() { return new HashTableMapDH<>(); }

    public <K,V> Map<K, V> newTestMapInstance(int capacity) { return new HashTableMapDH<>(capacity); }
    ...
    @Test
    void put() {
        Exception e = assertThrows(RuntimeException.class, () -> map.put(null, 0));
    ...
    @Test
    void get() {
        Exception e = assertThrows(RuntimeException.class, () -> map.get(null));
        assertEquals("Invalid key: null", e.getMessage());
